...
namespace ConversorDeTemperatura.Test
{
    ...
    {
        private readonly ConversorDeTemperatura _conversor;

        public ConversorDeTemperatura_Test()
        {
            // Inicializa o conversor de temperatura
            _conversor = new ConversorDeTemperatura();
        }
        ...
        public void ConverterCelsiusParaFahrenheit_DeveRetornarResultadoCorreto(double celsius, double fahrenheitEsperado)
        {
            ...
            double resultado = _conversor.ConverterCelsiusParaFahrenheit(celsius);
